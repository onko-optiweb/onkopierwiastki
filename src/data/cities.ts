...
export const cities: CityData[] = [
  {
    ...
    cityFaq: [
      { q: 'Gdzie zrobić onkopakiet we Wrocławiu?', a: 'Onkopierwiastki Wrocław możesz zbadać w certyfikowanych placówkach referencyjnych widocznych wyżej na tej stronie. Każda z nich pobiera krew pełną zgodnie z protokołem laboratorium Innowacyjna Medycyna — tylko w takich miejscach masz pewność wiarygodności wyniku.' },
      ...
      { q: 'Czy w placówkach we Wrocławiu jest parking?', a: 'Informacje o parkingu i dojazd znajdziesz przy każdej placówce na tej stronie. Wszystkie certyfikowane punkty pobrań onkopakietu we Wrocławiu są dobrze skomunikowane komunikacją miejską.' },
      { q: 'Czy badanie onkopierwiastków we Wrocławiu mogę wykonać w sobotę?', a: 'Placówki referencyjne we Wrocławiu działają co do zasady w dni robocze. Aktualne godziny otwarcia sprawdzisz dzwoniąc pod numer telefonu podany przy danej placówce na tej stronie.' },
    ],
