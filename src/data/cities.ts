...
export const cities: CityData[] = [
  {
    ...
    cityFaq: [
      { q: 'Gdzie zrobić onkopakiet we Wrocławiu?', a: 'Onkopakiet we Wrocławiu wykonasz w placówce referencyjnej DOLMED S.A. przy ul. Legnickiej 40. To certyfikowany punkt pobrań onkopakietu we Wrocławiu, który pobiera materiał zgodnie z protokołem laboratorium Innowacyjna Medycyna.' },
      ...
      { q: 'Czy w placówce DOLMED we Wrocławiu jest parking?', a: 'Tak — Dolnośląskie Centrum Medyczne DOLMED dysponuje parkingiem dla pacjentów. Placówka przy ul. Legnickiej 40 jest również dobrze skomunikowana komunikacją miejską — w pobliżu znajdują się przystanki tramwajowe i autobusowe.' },
      { q: 'Czy onkopakiet we Wrocławiu mogę wykonać w sobotę?', a: 'Godziny otwarcia placówki DOLMED we Wrocławiu obejmują dni robocze. Sprawdź aktualne godziny pracy placówki na jej stronie internetowej lub zadzwoń pod numer telefonu podany wyżej.' },
    ],
