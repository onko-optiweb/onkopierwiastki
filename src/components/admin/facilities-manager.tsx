      ...
      {showForm && (
        <div className="bg-white rounded-xl p-5 mb-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button onClick={closeForm} className="text-[#8a8fa6] hover:text-[#122056]"><X size={18} /></button>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <div className="flex items-center justify-between mb-1">
                ...
                <button type="button" onClick={geocodeAddress} disabled={geocoding || !form.address || !form.city}
          ...
          <div className="flex gap-2">
            ...
            <button onClick={closeForm} className="px-4 py-2 rounded-lg text-sm text-[#8a8fa6] hover:text-[#122056]">Anuluj</button>
          </div>
        </div>
      )}
